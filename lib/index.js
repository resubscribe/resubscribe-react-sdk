...
var ChatModalComponent = (0, goober_1.styled)('div')(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  height: 80vh;\n  max-width: 600px;\n  background-color: ", ";\n  position: relative;\n"], ["\n  height: 80vh;\n  max-width: 600px;\n  background-color: ", ";\n  position: relative;\n"])), function (props) { return props.bgcolor || 'white'; });
var ChatModal = function (_a) {
    var backgroundColor = _a.backgroundColor, children = _a.children;
    return (react_1.default.createElement(ChatModalComponent, { bgcolor: backgroundColor, style: __assign(__assign({}, modalSharedStyle), { animation: "".concat((0, goober_1.keyframes)(modalAnimation), " 150ms ease-in-out forwards") }) }, children));
};
