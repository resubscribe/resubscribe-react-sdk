...
exports.getNavigatorLanguage = void 0;
...
var baseUrl = 'https://app.resubscribe.ai';
var apiUrl = 'https://api.resubscribe.ai';
...
var Button = (0, goober_1.styled)('div')(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  flex: 1;\n  text-align: center;\n  padding: 0.5rem 0.75rem;\n  background-color: ", ";\n  color: ", ";\n  ", "\n  font-size: 0.875rem;\n  font-weight: 600;\n  border-radius: 6px;\n  cursor: pointer;\n"], ["\n  flex: 1;\n  text-align: center;\n  padding: 0.5rem 0.75rem;\n  background-color: ", ";\n  color: ", ";\n  ", "\n  font-size: 0.875rem;\n  font-weight: 600;\n  border-radius: 6px;\n  cursor: pointer;\n"])), function (props) { return props.backgroundColor || '#000'; }, function (props) { return props.color || '#fff'; }, function (props) { return props.secondaryColor ? "\n    border-width: 1px;\n    border-style: solid;\n    border-color: ".concat(reduceOpacity(props.secondaryColor, 0.3) || '#d4d7de', ";\n  ") : "\n    border: none;\n  "; });
...
var DialogModalComponent = (0, goober_1.styled)('div')(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  padding: 1.25rem;\n  max-width: 28rem;\n  background-color: ", ";\n  color: ", ";\n\n  @media (min-width: 576px) {\n    padding: 1.5rem;\n  }\n"], ["\n  padding: 1.25rem;\n  max-width: 28rem;\n  background-color: ", ";\n  color: ", ";\n\n  @media (min-width: 576px) {\n    padding: 1.5rem;\n  }\n"])), function (props) { return props.backgroundColor || 'white'; }, function (props) { return props.color || '#111827'; });
var DialogModal = function (_a) {
    var backgroundColor = _a.backgroundColor, color = _a.color, children = _a.children;
    return (react_1.default.createElement(DialogModalComponent, { backgroundColor: backgroundColor, color: color, style: __assign(__assign({}, modalSharedStyle), { animation: "".concat((0, goober_1.keyframes)(modalAnimation), " 150ms ease-in-out forwards") }) }, children));
};
...
var WebView = function (_a) {
    ...
    var url = (0, react_1.useMemo)(function () {
        ...
        var ret = "".concat(baseUrl, "/chat/").concat(options.slug, "?").concat(Object.entries(queryParams).map(function (_a) {
...
var ResubscribeComponent = function () {
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (state === 'confirming') {
            ...
            var params = {
                ...
                uid: options.userId,
                ait: options.aiType,
                brloc: (0, exports.getNavigatorLanguage)(),
            };
            var url = "".concat(apiUrl, "/v1/sessions/consent?").concat(Object.entries(params).map(function (_a) {
                var key = _a[0], value = _a[1];
                return "".concat(key, "=").concat(value);
            }).join('&'));
            fetch(url, {
    ...
    var isDark = !(colors === null || colors === void 0 ? void 0 : colors.background) ? false : isDarkColor(colors.background);
    if (state === 'confirming') {
        return (react_1.default.createElement(Container, { isDark: isDark },
            react_1.default.createElement(DialogModal, { backgroundColor: colors === null || colors === void 0 ? void 0 : colors.background, color: colors === null || colors === void 0 ? void 0 : colors.text },
                react_1.default.createElement("div", { className: cx(titleClass) }, title || getTitle(aiType)),
                react_1.default.createElement("div", { className: cx(descriptionClass) }, description || getDescription(aiType)),
                react_1.default.createElement("div", { className: cx(buttonsClass) },
                    react_1.default.createElement(Button, { onClick: function () {
                            useStore.setState({ state: 'closed' });
                        }, role: "button", tabIndex: 0, backgroundColor: "transparent", color: colors === null || colors === void 0 ? void 0 : colors.text, secondaryColor: colors === null || colors === void 0 ? void 0 : colors.text }, cancelButtonText || 'Not right now'),
                    react_1.default.createElement(Button, { onClick: function () {
                            useStore.setState({ state: 'open' });
                        }, backgroundColor: colors === null || colors === void 0 ? void 0 : colors.primary, color: isDark ? colors === null || colors === void 0 ? void 0 : colors.text : colors === null || colors === void 0 ? void 0 : colors.background, role: "button", tabIndex: 0 }, primaryButtonText || 'Let\'s chat!')))));
    }
    return (react_1.default.createElement(Container, { isDark: isDark },
